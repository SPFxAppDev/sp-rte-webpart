...
export default class RichTextPropertyPane extends React.Component<IRichTextPropertyPaneProps, IRichTextPropertyPaneState> {
  ...
  public render(): React.ReactElement<IRichTextPropertyPaneProps> {
    return (
      <Panel className={styles.richTextPropertyPane}
        ...
        closeButtonAriaLabel={strings.CUSTOM_CloseButton}
        ...
        <div>
          <div>
            ...
            <div className={styles.propertyPaneGroupContent}>
              <div className={styles.propertyPaneGroupHeaderNoAccordion}>{strings.CUSTOM_ParagraphSectionTitle}</div>
              {this.renderAlignmentStylesGroup()}
              {this.renderListStylesGroup()}
            </div>
            <div className={styles.propertyPaneGroupContent}>
              <div className={styles.propertyPaneGroupHeaderNoAccordion}>{strings.CUSTOM_HyperlinkSectionTitle}</div>
      ...
      <div className={styles.propertyPaneGroupField}>
        <div className="ms-CustomFieldHost">
          <div className={styles.controlsInOneRow}>
            <TooltipHost content={strings.CUSTOM_UndoTitle}
            ...
            <TooltipHost content={strings.CUSTOM_RedoTitle}
            ...
            <TooltipHost content={strings.CUSTOM_ClearFormattingTitle}
  ...
  private renderFontStylesGroup = (): JSX.Element => {
    ...
    return (
      <div className={styles.propertyPaneGroupField}>
        <Dropdown label={strings.CUSTOM_FontStyleTitle}
          ariaLabel={strings.CUSTOM_FontStyleTitle}
          defaultSelectedKey={0}
          selectedKey={selectedHeader}
          options={[
            { key: 0, text: strings.CUSTOM_HeaderNormalText },
            { key: 2, text: strings.CUSTOM_HeaderH2 },
            { key: 3, text: strings.CUSTOM_HeaderH3 },
            { key: 4, text: strings.CUSTOM_HeaderH4 },
            { key: 7, text: strings.CUSTOM_HeaderBlockQuote }
          ]}
  ...
  private renderFontSizesGroup = (): JSX.Element => {
    ...
    return (
      <div className={styles.propertyPaneGroupField}>
        <Dropdown label={strings.CUSTOM_FontSizeTitle}
          ariaLabel={strings.CUSTOM_FontSizeTitle}
  ...
  private renderInlineStylesGroup = (): JSX.Element => {
    return (
      <div className={styles.propertyPaneGroupField}>
        <div className="ms-CustomFieldHost">
          <div className={styles.controlsInOneRow}>
            <TooltipHost content={strings.CUSTOM_BoldTitle}
            ...
            <TooltipHost content={strings.CUSTOM_ItalicTitle}
            ...
            <TooltipHost content={strings.CUSTOM_UnderlineTitle}
            ...
            <TooltipHost content={strings.CUSTOM_StrikethroughTitle}
            ...
            <TooltipHost content={strings.CUSTOM_SuperscriptTitle}
            ...
            <TooltipHost content={strings.CUSTOM_SubscriptTitle}
        ...
        <div className="ms-CustomFieldHost">
          <div className={styles.controlsInOneRow}>
            <RteColorPicker colorPickerGroups={fontColorGroups} // changed to variable
              ...
              buttonLabel={strings.CUSTOM_FontColorLabel}
              id="fontColor-propertyPaneButton"
              defaultButtonLabel={strings.CUSTOM_AutomaticFontColor}
              fillThemeColor={true}
              previewColor={color}
              selectedColor={color}
            ...
            <RteColorPicker buttonLabel={strings.CUSTOM_HighlightColorLabel}
              colorPickerGroups={[
                "highlightColors"
              ]}
              ...
              defaultButtonLabel={strings.CUSTOM_NoColorHighlightColor}
  ...
  private renderAlignmentStylesGroup = (): JSX.Element => {
    return (
      <div className={styles.propertyPaneGroupField}>
        <div className="ms-CustomFieldHost">
          <div className={styles.controlsInOneRow}>
            <TooltipHost content={strings.CUSTOM_AlignLeft}
            ...
            <TooltipHost content={strings.CUSTOM_AlignCenter}
            ...
            <TooltipHost content={strings.CUSTOM_AlignRight}
            ...
            <TooltipHost content={strings.CUSTOM_AlignJustify}
            ...
            <TooltipHost content={strings.CUSTOM_IncreaseIndentTitle}
            ...
            <TooltipHost content={strings.CUSTOM_DecreaseIndentTitle}
  ...
  private renderListStylesGroup = (): JSX.Element => {
    return <div className={styles.propertyPaneGroupField}>
      <div className="ms-CustomFieldHost">
        <div className={styles.controlsInOneRow}>
          <TooltipHost content={strings.CUSTOM_ListBullet}
          ...
          <TooltipHost content={strings.CUSTOM_ListNumbered}
  ...
  private renderHyperlinkStylesGroup = (): JSX.Element => {
    return (
      <div className={styles.propertyPaneGroupField}>
        <div className="ms-CustomFieldHost">
          <div className={styles.controlsInOneRow}>
            <TooltipHost content={strings.CUSTOM_LinkTitle}
            ...
            <TooltipHost content={strings.CUSTOM_RemoveLinkLabel}
  ...
  private handleRenderNavigation = (): JSX.Element => {
    return (
      <div className={styles.formattingPaneTitle} aria-hidden="true">{strings.CUSTOM_FormattingPaneTitle}
        <IconButton onClick={() => this.props.onClose()}
          className={styles.propertyPaneClose}
          iconProps={{
            iconName: 'Cancel'
          }}
          title={strings.CUSTOM_CloseButton}
          ariaLabel={strings.CUSTOM_CloseButton} />
      </div>
    );
  }
}
